...
<div class="ui grid">
  <div class="twelve wide column">
    ...
    <div class="ui raised segment">
      <a class="ui teal right ribbon label">Participantes</a>
      	<p><a class="ui label">
    ...
    <a class="ui label">
		<img class="ui right spaced avatar image" src="../../imagens/juty.jpg">Jutyara</a>
		</p>
      <p></p>
      <div class="ui divider"></div>
      <a class="ui teal right ribbon label">Ong's Parceiras</a>
      <p></p>
      <p><a class="ui label">
	    ...
	    <a class="ui label">
		<img class="ui right spaced avatar image" src="../../imagens/5.jpg">Ong Ame Bicho</a>
    	<p></p>
    	<a class="ui label">
    	<img class="ui right spaced avatar image" src="../../imagens/4.jpg">Em Ação</a>
    	<a class="ui label">
    	<img class="ui right spaced avatar image" src="../../imagens/10.jpg">Ong na Minha Cidade</a>
